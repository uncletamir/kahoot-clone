...
socket.on('connect', function(){
    socket.emit('requestmodulgambar');//Get database names to display to user
});


socket.on('responmodulgambar', function(data){
...
function startGame(data) {
    window.location.href="../../hostacakgambar/" + "?id=" + data;
...
function tambahSoal () {
  window.location.href="../creategambar";
}
