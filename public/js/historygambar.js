...
socket.on('connect', function(){
    socket.emit('requesthistorygambar');//Get database names to display to user
});


socket.on('responhistorygambar', function(data){
...
function showhistory(data) {
    window.location.href="../../showhistorygambar/" + "?id=" + data;
